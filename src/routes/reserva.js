...
router.get('/:pk_sala/:pk_funcion/:pk_numero_identificacion',rCotroller.disponibilidadSillas); // Se elimina la autenticación para pruebas con Capataz 14 de marzo de 2020
