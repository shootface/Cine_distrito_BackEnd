...
async function get_funcion_pelicula(req,res){
    ...
    try {
        await poo.query("\
        select multiplex.v_nombre,funcion_sala.id,funcion_sala.fk_funcion,funcion_sala.fk_sala,funcion.t_inicioproyeccion, funcion.t_finproyeccion, funcion.v_estado, funcion.v_tipo_proyeccion, sala.i_numsala\
